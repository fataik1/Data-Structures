class Node:
    ...
    def get_value(self):
        #this will return the Node's data
        return self.value

    def get_next(self):
        #Will return next node reference
        return self.next_node

    def set_next(self, new_next):
        #node's next reference to the new next
        self.next = new_next
...
class LinkedList:
    ...
    #adds some data to the end of the linkedlist
    #This operation doesn't depend on the size of the linked list
    def add_to_tail(self, data):
    # 1. wrap the data in a node instance 
        new_node = Node(data)
